...
{
    public abstract class ZeroMqFeederConfiguration : AbstractZeroMqFeevidersConfiguration, IAbstractFeederConfiguration
    {
        ...
        /// <summary>Subscription topic prefix. Only meaningful when <see cref="AbstractZeroMqFeevidersConfiguration.SocketPattern"/> is <see cref="ZeroMqSocketPattern.PubSub"/>; ignored for PushPull.</summary>
