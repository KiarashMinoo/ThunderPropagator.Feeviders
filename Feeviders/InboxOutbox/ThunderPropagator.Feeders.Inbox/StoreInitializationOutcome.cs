...
{
    /// <summary>Result of one <see cref="IInboxStoreInitializer.InitializeAsync"/> call. See <see cref="StoreInitializationResult.IsReady"/> for which of these mean a worker may safely proceed.</summary>
