...
{
    /// <summary>Outcome of one <see cref="IInboxStoreInitializer.InitializeAsync"/> call.</summary>
    public sealed record StoreInitializationResult
    {
        ...
        /// <summary>
        /// Whether a worker may safely start consuming/relaying against this store - <see langword="true"/>
        /// for <see cref="StoreInitializationOutcome.Ready"/>, <see cref="StoreInitializationOutcome.Upgraded"/>,
