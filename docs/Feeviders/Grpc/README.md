...
The **Grpc** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.Grpc](./Feeders.Grpc/README.md) `Types:3` `Files:7`
- [Grpc.SharedKernel](./Grpc.SharedKernel/README.md) `Types:1` `Files:5`
- [Providers.DotNet.Grpc](./Providers.DotNet.Grpc/README.md) `Types:3` `Files:6`
...
graph TD
  Current["Grpc"]
  Current --> C0["Feeders.Grpc"]
  Current --> C1["Grpc.SharedKernel"]
  Current --> C2["Providers.DotNet.Grpc"]
```

The diagram shows the direct components documented by the **Grpc** area.
