...
The **Feeders.AzureServiceBus** area groups 3 documented types, including `AzureServiceBusFeederExtensions`, `ServiceBusFeederConfiguration`, `ServiceBusFeederMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `AzureServiceBusFeederExtensions.cs` | `AzureServiceBusFeederExtensions` | 68 | Defines AzureServiceBusFeederExtensions and its related behavior. |
| `ServiceBusFeeder.cs` | `ServiceBusFeeder`, `Log` | 131 | Defines ServiceBusFeeder, Log and its related behavior. |
| `ServiceBusFeederConfiguration.cs` | `ServiceBusFeederConfiguration` | 37 | Defines ServiceBusFeederConfiguration and its related behavior. |
| `ServiceBusFeederMessage.cs` | `ServiceBusFeederMessage` | 5 | Defines ServiceBusFeederMessage and its related behavior. |
| `ServiceBusMessageContext.cs` | `ServiceBusMessageContext` | 7 | Defines ServiceBusMessageContext and its related behavior. |
| `ServiceBusMessageSettlement.cs` | `ServiceBusMessageSettlement` | 60 | Defines ServiceBusMessageSettlement and its related behavior. |
| `ThunderPropagator.Feeders.AzureServiceBus.csproj` | — | 8 | Defines project build targets, dependencies, and package metadata. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`AzureServiceBusFeederExtensions`](#azureservicebusfeederextensions) | class | Represents the AzureServiceBusFeederExtensions class. | — | — |
| [`ServiceBusFeederConfiguration`](#servicebusfeederconfiguration) | class | Represents the ServiceBusFeederConfiguration class. | `AbstractFeederConfiguration, IAzureServiceBusFeeviderConfiguration` | — |
| [`ServiceBusFeederMessage`](#servicebusfeedermessage) | class | Represents the ServiceBusFeederMessage class. | `FeederMessage;` | — |

### AzureServiceBusFeederExtensions
...
- **Summary:** Represents the AzureServiceBusFeederExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve AzureServiceBusFeederExtensions from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### ServiceBusFeederConfiguration

- **Kind:** class
- **Namespace:** `ThunderPropagator.Feeders.AzureServiceBus`
- **Inherits/implements:** `AbstractFeederConfiguration, IAzureServiceBusFeeviderConfiguration`
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the ServiceBusFeederConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve ServiceBusFeederConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### ServiceBusFeederMessage
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the ServiceBusFeederMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve ServiceBusFeederMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Feeders.AzureServiceBus"]
  Current --> T0["AzureServiceBusFeederExtensions"]
  Current --> T1["ServiceBusFeederConfiguration"]
  Current --> T2["ServiceBusFeederMessage"]
```

The diagram shows the direct components documented by the **Feeders.AzureServiceBus** area.

## Examples

Start with `AzureServiceBusFeederExtensions` as the primary entry point for this folder, then follow its linked contracts and collaborators.
