...
The **AzureServiceBus** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [AzureServiceBus.SharedKernel](./AzureServiceBus.SharedKernel/README.md) `Types:1` `Files:6`
- [Feeders.AzureServiceBus](./Feeders.AzureServiceBus/README.md) `Types:3` `Files:8`
- [Providers.DotNet.AzureServiceBus](./Providers.DotNet.AzureServiceBus/README.md) `Types:4` `Files:7`
...
graph TD
  ...
  Current --> C0["AzureServiceBus.SharedKernel"]
  Current --> C1["Feeders.AzureServiceBus"]
  Current --> C2["Providers.DotNet.AzureServiceBus"]
```
