...
The **TcpSocket** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.TcpSocket](./Feeders.TcpSocket/README.md) `Types:3` `Files:6`
- [Providers.DotNet.TcpSocket](./Providers.DotNet.TcpSocket/README.md) `Types:3` `Files:7`
- [TcpSocket.SharedKernel](./TcpSocket.SharedKernel/README.md) `Types:1` `Files:5`
...
graph TD
  Current["TcpSocket"]
  Current --> C0["Feeders.TcpSocket"]
  Current --> C1["Providers.DotNet.TcpSocket"]
  Current --> C2["TcpSocket.SharedKernel"]
```
