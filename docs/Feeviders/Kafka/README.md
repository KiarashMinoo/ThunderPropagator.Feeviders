...
The **Kafka** area organizes 2 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.Kafka](./Feeders.Kafka/README.md) `Types:3` `Files:9`
- [Providers.DotNet.Kafka](./Providers.DotNet.Kafka/README.md) `Types:3` `Files:7`
...
graph TD
  Current["Kafka"]
  Current --> C0["Feeders.Kafka"]
  Current --> C1["Providers.DotNet.Kafka"]
```
