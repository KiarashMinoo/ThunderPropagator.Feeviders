...
The **Pulsar** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.Pulsar](./Feeders.Pulsar/README.md) `Types:3` `Files:7`
- [Providers.DotNet.Pulsar](./Providers.DotNet.Pulsar/README.md) `Types:3` `Files:6`
- [Pulsar.SharedKernel](./Pulsar.SharedKernel/README.md) `Types:1` `Files:5`
...
graph TD
  Current["Pulsar"]
  Current --> C0["Feeders.Pulsar"]
  Current --> C1["Providers.DotNet.Pulsar"]
  Current --> C2["Pulsar.SharedKernel"]
```
