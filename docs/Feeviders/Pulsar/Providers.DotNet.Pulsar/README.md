...
The **Providers.DotNet.Pulsar** area groups 3 documented types, including `PulsarProviderConfiguration`, `PulsarProviderExtensions`, `PulsarProviderMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `PulsarProvider.cs` | `PulsarProvider`, `Log` | 111 | Defines PulsarProvider, Log and its related behavior. |
| `PulsarProviderConfiguration.cs` | `PulsarProviderConfiguration` | 65 | Defines PulsarProviderConfiguration and its related behavior. |
| `PulsarProviderExtensions.cs` | `PulsarProviderExtensions` | 35 | Defines PulsarProviderExtensions and its related behavior. |
| `PulsarProviderMessage.cs` | `PulsarProviderMessage` | 6 | Defines PulsarProviderMessage and its related behavior. |
| `ThunderPropagator.Providers.DotNet.Pulsar.csproj` | — | 8 | Defines project build targets, dependencies, and package metadata. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`PulsarProviderConfiguration`](#pulsarproviderconfiguration) | class | Represents the PulsarProviderConfiguration class. | `AbstractPulsarFeevidersConfiguration, IAbstractProviderConfiguration` | — |
| [`PulsarProviderExtensions`](#pulsarproviderextensions) | class | Represents the PulsarProviderExtensions class. | — | — |
| [`PulsarProviderMessage`](#pulsarprovidermessage) | class | Represents the PulsarProviderMessage class. | `FeederMessage;` | — |

### PulsarProviderConfiguration

- **Kind:** class
- **Namespace:** `ThunderPropagator.Providers.DotNet.Pulsar`
- **Inherits/implements:** `AbstractPulsarFeevidersConfiguration, IAbstractProviderConfiguration`
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the PulsarProviderConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve PulsarProviderConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### PulsarProviderExtensions
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the PulsarProviderExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve PulsarProviderExtensions from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### PulsarProviderMessage
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the PulsarProviderMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve PulsarProviderMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Providers.DotNet.Pulsar"]
  Current --> T0["PulsarProviderConfiguration"]
  Current --> T1["PulsarProviderExtensions"]
  Current --> T2["PulsarProviderMessage"]
```

The diagram shows the direct components documented by the **Providers.DotNet.Pulsar** area.

## Examples

Start with `PulsarProviderConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.

## See Also

- [Parent area](../README.md)
- [Feeders.Pulsar](../Feeders.Pulsar/README.md)
