...
The **Feeders.Pulsar** area groups 3 documented types, including `PulsarFeederConfiguration`, `PulsarFeederExtensions`, `PulsarFeederMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `PulsarFeeder.cs` | `PulsarFeeder`, `Log` | 190 | Defines PulsarFeeder, Log and its related behavior. |
| `PulsarFeederConfiguration.cs` | `PulsarFeederConfiguration` | 91 | Defines PulsarFeederConfiguration and its related behavior. |
| `PulsarFeederExtensions.cs` | `PulsarFeederExtensions` | 75 | Defines PulsarFeederExtensions and its related behavior. |
| `PulsarFeederMessage.cs` | `PulsarFeederMessage` | 6 | Defines PulsarFeederMessage and its related behavior. |
| `PulsarMessageSettlement.cs` | `PulsarMessageSettlement` | 44 | Defines PulsarMessageSettlement and its related behavior. |
| `ThunderPropagator.Feeders.Pulsar.csproj` | — | 8 | Defines project build targets, dependencies, and package metadata. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`PulsarFeederConfiguration`](#pulsarfeederconfiguration) | class | Represents the PulsarFeederConfiguration class. | `AbstractPulsarFeevidersConfiguration, IAbstractFeederConfiguration` | `ReceiveTimeout`, `StartupTimeout`, `MessageHandlerTimeout`, `MemoryPressurePauseThreshold`, `MemoryPressureResumeThreshold`, `MemoryPressurePollingInterval` |
| [`PulsarFeederExtensions`](#pulsarfeederextensions) | class | Represents the PulsarFeederExtensions class. | — | — |
| [`PulsarFeederMessage`](#pulsarfeedermessage) | class | Represents the PulsarFeederMessage class. | `FeederMessage;` | — |

### PulsarFeederConfiguration

- **Kind:** class
- **Namespace:** `ThunderPropagator.Feeders.Pulsar`
- **Inherits/implements:** `AbstractPulsarFeevidersConfiguration, IAbstractFeederConfiguration`
- **Attributes:** None detected
- **Key members:** `ReceiveTimeout`, `StartupTimeout`, `MessageHandlerTimeout`, `MemoryPressurePauseThreshold`, `MemoryPressureResumeThreshold`, `MemoryPressurePollingInterval`
- **Summary:** Represents the PulsarFeederConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve PulsarFeederConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### PulsarFeederExtensions
...
- **Summary:** Represents the PulsarFeederExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve PulsarFeederExtensions from the configured service container or construct it with its declared dependencies.
```
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the PulsarFeederMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve PulsarFeederMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Feeders.Pulsar"]
  Current --> T0["PulsarFeederConfiguration"]
  Current --> T1["PulsarFeederExtensions"]
  Current --> T2["PulsarFeederMessage"]
```

The diagram shows the direct components documented by the **Feeders.Pulsar** area.

## Examples

Start with `PulsarFeederConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.

## See Also

- [Parent area](../README.md)
- [Providers.DotNet.Pulsar](../Providers.DotNet.Pulsar/README.md)
- [Pulsar.SharedKernel](../Pulsar.SharedKernel/README.md)
