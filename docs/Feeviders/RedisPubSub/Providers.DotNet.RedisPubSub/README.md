...
The **Providers.DotNet.RedisPubSub** area groups 3 documented types, including `RedisPubSubProviderConfiguration`, `RedisPubSubProviderExtensions`, `RedisPubSubProviderMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `RedisPubSubProvider.cs` | `RedisPubSubProvider`, `Log` | 112 | Defines RedisPubSubProvider, Log and its related behavior. |
| `RedisPubSubProviderConfiguration.cs` | `RedisPubSubProviderConfiguration` | 26 | Defines RedisPubSubProviderConfiguration and its related behavior. |
| `RedisPubSubProviderExtensions.cs` | `RedisPubSubProviderExtensions` | 29 | Defines RedisPubSubProviderExtensions and its related behavior. |
| `RedisPubSubProviderMessage.cs` | `RedisPubSubProviderMessage` | 8 | Defines RedisPubSubProviderMessage and its related behavior. |
| `ThunderPropagator.Providers.DotNet.RedisPubSub.csproj` | — | 12 | Defines project build targets, dependencies, and package metadata. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`RedisPubSubProviderConfiguration`](#redispubsubproviderconfiguration) | class | Represents the RedisPubSubProviderConfiguration class. | `AbstractProviderConfiguration` | — |
| [`RedisPubSubProviderExtensions`](#redispubsubproviderextensions) | class | Represents the RedisPubSubProviderExtensions class. | — | — |
| [`RedisPubSubProviderMessage`](#redispubsubprovidermessage) | class | Represents the RedisPubSubProviderMessage class. | `FeederMessage` | — |
...
- **Summary:** Represents the RedisPubSubProviderConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RedisPubSubProviderConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### RedisPubSubProviderExtensions
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the RedisPubSubProviderExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RedisPubSubProviderExtensions from the configured service container or construct it with its declared dependencies.
```
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the RedisPubSubProviderMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RedisPubSubProviderMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Providers.DotNet.RedisPubSub"]
  Current --> T0["RedisPubSubProviderConfiguration"]
  Current --> T1["RedisPubSubProviderExtensions"]
  Current --> T2["RedisPubSubProviderMessage"]
```

The diagram shows the direct components documented by the **Providers.DotNet.RedisPubSub** area.

## Examples

Start with `RedisPubSubProviderConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.

## See Also

- [Parent area](../README.md)
- [Feeders.RedisPubSub](../Feeders.RedisPubSub/README.md)
