...
The **Feeders.RedisPubSub** area groups 3 documented types, including `RedisPubSubFeederConfiguration`, `RedisPubSubFeederExtensions`, `RedisPubSubFeederMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `RedisPubSubFeeder.cs` | `RedisPubSubFeeder`, `Log` | 175 | Defines RedisPubSubFeeder, Log and its related behavior. |
| `RedisPubSubFeederConfiguration.cs` | `RedisPubSubFeederConfiguration` | 48 | Defines RedisPubSubFeederConfiguration and its related behavior. |
| `RedisPubSubFeederExtensions.cs` | `RedisPubSubFeederExtensions` | 67 | Defines RedisPubSubFeederExtensions and its related behavior. |
| `RedisPubSubFeederMessage.cs` | `RedisPubSubFeederMessage` | 8 | Defines RedisPubSubFeederMessage and its related behavior. |
| `RedisPubSubMessageHandler.cs` | `RedisPubSubMessageHandler` | 20 | Defines RedisPubSubMessageHandler and its related behavior. |
| `ThunderPropagator.Feeders.RedisPubSub.csproj` | — | 12 | Defines project build targets, dependencies, and package metadata. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`RedisPubSubFeederConfiguration`](#redispubsubfeederconfiguration) | class | Represents the RedisPubSubFeederConfiguration class. | `AbstractFeederConfiguration` | — |
| [`RedisPubSubFeederExtensions`](#redispubsubfeederextensions) | class | Represents the RedisPubSubFeederExtensions class. | — | — |
| [`RedisPubSubFeederMessage`](#redispubsubfeedermessage) | class | Represents the RedisPubSubFeederMessage class. | `FeederMessage` | — |
...
- **Summary:** Represents the RedisPubSubFeederConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RedisPubSubFeederConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### RedisPubSubFeederExtensions
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the RedisPubSubFeederExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RedisPubSubFeederExtensions from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### RedisPubSubFeederMessage
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the RedisPubSubFeederMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RedisPubSubFeederMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Feeders.RedisPubSub"]
  Current --> T0["RedisPubSubFeederConfiguration"]
  Current --> T1["RedisPubSubFeederExtensions"]
  Current --> T2["RedisPubSubFeederMessage"]
```

The diagram shows the direct components documented by the **Feeders.RedisPubSub** area.

## Examples

Start with `RedisPubSubFeederConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.

## See Also

- [Parent area](../README.md)
- [Providers.DotNet.RedisPubSub](../Providers.DotNet.RedisPubSub/README.md)
- [RedisPubSub.SharedKernel](../RedisPubSub.SharedKernel/README.md)
