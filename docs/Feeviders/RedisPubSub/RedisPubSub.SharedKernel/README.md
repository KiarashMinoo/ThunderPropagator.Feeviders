...
The **RedisPubSub.SharedKernel** area groups 1 documented type, including `RedisPubSubTelemetry`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `RedisPubSubTelemetry.cs` | `RedisPubSubTelemetry` | 29 | Defines RedisPubSubTelemetry and its related behavior. |
| `ThunderPropagator.Feeviders.RedisPubSub.SharedKernel.csproj` | — | 8 | Defines project build targets, dependencies, and package metadata. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`RedisPubSubTelemetry`](#redispubsubtelemetry) | class | Represents the RedisPubSubTelemetry class. | — | — |

### RedisPubSubTelemetry
...
- **Summary:** Represents the RedisPubSubTelemetry class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RedisPubSubTelemetry from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["RedisPubSub.SharedKernel"]
  Current --> T0["RedisPubSubTelemetry"]
```

The diagram shows the direct components documented by the **RedisPubSub.SharedKernel** area.

## Examples

Start with `RedisPubSubTelemetry` as the primary entry point for this folder, then follow its linked contracts and collaborators.
