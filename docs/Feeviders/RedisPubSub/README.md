...
The **RedisPubSub** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.RedisPubSub](./Feeders.RedisPubSub/README.md) `Types:3` `Files:7`
- [Providers.DotNet.RedisPubSub](./Providers.DotNet.RedisPubSub/README.md) `Types:3` `Files:6`
- [RedisPubSub.SharedKernel](./RedisPubSub.SharedKernel/README.md) `Types:1` `Files:3`
...
graph TD
  Current["RedisPubSub"]
  Current --> C0["Feeders.RedisPubSub"]
  Current --> C1["Providers.DotNet.RedisPubSub"]
  Current --> C2["RedisPubSub.SharedKernel"]
```
