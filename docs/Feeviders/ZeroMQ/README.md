...
The **ZeroMQ** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.ZeroMQ](./Feeders.ZeroMQ/README.md) `Types:3` `Files:6`
- [Providers.DotNet.ZeroMQ](./Providers.DotNet.ZeroMQ/README.md) `Types:3` `Files:6`
- [ZeroMQ.SharedKernel](./ZeroMQ.SharedKernel/README.md) `Types:2` `Files:6`
...
graph TD
  Current["ZeroMQ"]
  Current --> C0["Feeders.ZeroMQ"]
  Current --> C1["Providers.DotNet.ZeroMQ"]
  Current --> C2["ZeroMQ.SharedKernel"]
```

The diagram shows the direct components documented by the **ZeroMQ** area.
