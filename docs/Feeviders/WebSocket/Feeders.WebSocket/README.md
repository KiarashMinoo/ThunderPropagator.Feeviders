...
The **Feeders.WebSocket** area groups 3 documented types, including `WebSocketFeederConfiguration`, `WebSocketFeederExtensions`, `WebSocketFeederMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `ThunderPropagator.Feeders.WebSocket.csproj` | — | 9 | Defines project build targets, dependencies, and package metadata. |
| `WebSocketFeeder.cs` | `WebSocketFeeder`, `Log` | 79 | Defines WebSocketFeeder, Log and its related behavior. |
| `WebSocketFeederConfiguration.cs` | `WebSocketFeederConfiguration` | 77 | Defines WebSocketFeederConfiguration and its related behavior. |
| `WebSocketFeederExtensions.cs` | `WebSocketFeederExtensions` | 150 | Defines WebSocketFeederExtensions and its related behavior. |
| `WebSocketFeederMessage.cs` | `WebSocketFeederMessage` | 6 | Defines WebSocketFeederMessage and its related behavior. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`WebSocketFeederConfiguration`](#websocketfeederconfiguration) | class | Represents the WebSocketFeederConfiguration class. | `WebSocketConfiguration,` | — |
| [`WebSocketFeederExtensions`](#websocketfeederextensions) | class | Represents the WebSocketFeederExtensions class. | — | — |
| [`WebSocketFeederMessage`](#websocketfeedermessage) | class | Represents the WebSocketFeederMessage class. | `FeederMessage;` | — |

### WebSocketFeederConfiguration

- **Kind:** class
- **Namespace:** `ThunderPropagator.Feeders.WebSocket`
- **Inherits/implements:** `WebSocketConfiguration,`
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the WebSocketFeederConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve WebSocketFeederConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### WebSocketFeederExtensions
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the WebSocketFeederExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve WebSocketFeederExtensions from the configured service container or construct it with its declared dependencies.
```
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the WebSocketFeederMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve WebSocketFeederMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Feeders.WebSocket"]
  Current --> T0["WebSocketFeederConfiguration"]
  Current --> T1["WebSocketFeederExtensions"]
  Current --> T2["WebSocketFeederMessage"]
```

The diagram shows the direct components documented by the **Feeders.WebSocket** area.

## Examples

Start with `WebSocketFeederConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.
