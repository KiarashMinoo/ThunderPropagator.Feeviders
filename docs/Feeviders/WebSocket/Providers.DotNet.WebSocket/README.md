...
The **Providers.DotNet.WebSocket** area groups 3 documented types, including `WebSocketProviderConfiguration`, `WebSocketProviderExtensions`, `WebSocketProviderMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `ClientWebSocketFactory.cs` | `ClientWebSocketFactory` | 18 | Defines ClientWebSocketFactory and its related behavior. |
| `ThunderPropagator.Providers.DotNet.WebSocket.csproj` | — | 9 | Defines project build targets, dependencies, and package metadata. |
| `WebSocketProvider.cs` | `WebSocketProvider`, `Log` | 114 | Defines WebSocketProvider, Log and its related behavior. |
| `WebSocketProviderConfiguration.cs` | `WebSocketProviderConfiguration` | 13 | Defines WebSocketProviderConfiguration and its related behavior. |
| `WebSocketProviderExtensions.cs` | `WebSocketProviderExtensions` | 46 | Defines WebSocketProviderExtensions and its related behavior. |
| `WebSocketProviderMessage.cs` | `WebSocketProviderMessage` | 6 | Defines WebSocketProviderMessage and its related behavior. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`WebSocketProviderConfiguration`](#websocketproviderconfiguration) | class | Represents the WebSocketProviderConfiguration class. | `AbstractProviderConfiguration` | — |
| [`WebSocketProviderExtensions`](#websocketproviderextensions) | class | Represents the WebSocketProviderExtensions class. | — | — |
| [`WebSocketProviderMessage`](#websocketprovidermessage) | class | Represents the WebSocketProviderMessage class. | `FeederMessage;` | — |
...
- **Summary:** Represents the WebSocketProviderConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve WebSocketProviderConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### WebSocketProviderExtensions
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the WebSocketProviderExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve WebSocketProviderExtensions from the configured service container or construct it with its declared dependencies.
```
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the WebSocketProviderMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve WebSocketProviderMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Providers.DotNet.WebSocket"]
  Current --> T0["WebSocketProviderConfiguration"]
  Current --> T1["WebSocketProviderExtensions"]
  Current --> T2["WebSocketProviderMessage"]
```

The diagram shows the direct components documented by the **Providers.DotNet.WebSocket** area.

## Examples

Start with `WebSocketProviderConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.
