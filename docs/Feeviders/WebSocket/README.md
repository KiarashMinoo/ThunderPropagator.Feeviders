...
The **WebSocket** area organizes 2 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.WebSocket](./Feeders.WebSocket/README.md) `Types:3` `Files:6`
- [Providers.DotNet.WebSocket](./Providers.DotNet.WebSocket/README.md) `Types:3` `Files:7`
...
graph TD
  Current["WebSocket"]
  Current --> C0["Feeders.WebSocket"]
  Current --> C1["Providers.DotNet.WebSocket"]
```
