...
The **Feeders.RabbitMQ** area groups 3 documented types, including `RabbitMQFeederConfiguration`, `RabbitMQFeederExtensions`, `RabbitMQFeederMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `RabbitMQDeliveryAcknowledger.cs` | `RabbitMQDeliveryAcknowledger` | 30 | Defines RabbitMQDeliveryAcknowledger and its related behavior. |
| `RabbitMQFeeder.cs` | `RabbitMQFeeder`, `Log` | 438 | Defines RabbitMQFeeder, Log and its related behavior. |
| `RabbitMQFeederConfiguration.cs` | `RabbitMQFeederConfiguration` | 88 | Defines RabbitMQFeederConfiguration and its related behavior. |
| `RabbitMQFeederExtensions.cs` | `RabbitMQFeederExtensions` | 78 | Defines RabbitMQFeederExtensions and its related behavior. |
| `RabbitMQFeederMessage.cs` | `RabbitMQFeederMessage` | 8 | Defines RabbitMQFeederMessage and its related behavior. |
| `RabbitMQReconnectDelay.cs` | `RabbitMQReconnectDelay` | 17 | Defines RabbitMQReconnectDelay and its related behavior. |
| `ThunderPropagator.Feeders.RabbitMQ.csproj` | — | 8 | Defines project build targets, dependencies, and package metadata. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`RabbitMQFeederConfiguration`](#rabbitmqfeederconfiguration) | class | Represents the RabbitMQFeederConfiguration class. | `RabbitMQFeeviderConfiguration, IAbstractFeederConfiguration` | — |
| [`RabbitMQFeederExtensions`](#rabbitmqfeederextensions) | class | Represents the RabbitMQFeederExtensions class. | — | — |
| [`RabbitMQFeederMessage`](#rabbitmqfeedermessage) | class | Represents the RabbitMQFeederMessage class. | `FeederMessage` | — |

### RabbitMQFeederConfiguration

- **Kind:** class
- **Namespace:** `ThunderPropagator.Feeders.RabbitMQ`
- **Inherits/implements:** `RabbitMQFeeviderConfiguration, IAbstractFeederConfiguration`
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the RabbitMQFeederConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RabbitMQFeederConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### RabbitMQFeederExtensions
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the RabbitMQFeederExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RabbitMQFeederExtensions from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### RabbitMQFeederMessage
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the RabbitMQFeederMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve RabbitMQFeederMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Feeders.RabbitMQ"]
  Current --> T0["RabbitMQFeederConfiguration"]
  Current --> T1["RabbitMQFeederExtensions"]
  Current --> T2["RabbitMQFeederMessage"]
```

The diagram shows the direct components documented by the **Feeders.RabbitMQ** area.

## Examples

Start with `RabbitMQFeederConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.

## See Also

- [Parent area](../README.md)
- [Providers.DotNet.RabbitMQ](../Providers.DotNet.RabbitMQ/README.md)
- [RabbitMQ.SharedKernel](../RabbitMQ.SharedKernel/README.md)
