...
The **RabbitMQ** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.RabbitMQ](./Feeders.RabbitMQ/README.md) `Types:3` `Files:8`
- [Providers.DotNet.RabbitMQ](./Providers.DotNet.RabbitMQ/README.md) `Types:3` `Files:6`
- [RabbitMQ.SharedKernel](./RabbitMQ.SharedKernel/README.md) `Types:1` `Files:4`
...
graph TD
  Current["RabbitMQ"]
  Current --> C0["Feeders.RabbitMQ"]
  Current --> C1["Providers.DotNet.RabbitMQ"]
  Current --> C2["RabbitMQ.SharedKernel"]
```
