...
The **UdpClient** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.UdpClient](./Feeders.UdpClient/README.md) `Types:3` `Files:6`
- [Providers.DotNet.UdpClient](./Providers.DotNet.UdpClient/README.md) `Types:3` `Files:6`
- [UdpClient.SharedKernel](./UdpClient.SharedKernel/README.md) `Types:2` `Files:4`
...
graph TD
  Current["UdpClient"]
  Current --> C0["Feeders.UdpClient"]
  Current --> C1["Providers.DotNet.UdpClient"]
  Current --> C2["UdpClient.SharedKernel"]
```
