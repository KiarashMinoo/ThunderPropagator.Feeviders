...
The **Feeders.UdpClient** area groups 3 documented types, including `UdpClientFeederConfiguration`, `UdpClientFeederExtensions`, `UdpClientFeederMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `ThunderPropagator.Feeders.UdpClient.csproj` | — | 9 | Defines project build targets, dependencies, and package metadata. |
| `UdpClientFeeder.cs` | `UdpClientFeeder`, `Log` | 229 | Defines UdpClientFeeder, Log and its related behavior. |
| `UdpClientFeederConfiguration.cs` | `UdpClientFeederConfiguration` | 37 | Defines UdpClientFeederConfiguration and its related behavior. |
| `UdpClientFeederExtensions.cs` | `UdpClientFeederExtensions` | 66 | Defines UdpClientFeederExtensions and its related behavior. |
| `UdpClientFeederMessage.cs` | `UdpClientFeederMessage` | 6 | Defines UdpClientFeederMessage and its related behavior. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`UdpClientFeederConfiguration`](#udpclientfeederconfiguration) | class | Represents the UdpClientFeederConfiguration class. | `AbstractFeederConfiguration` | — |
| [`UdpClientFeederExtensions`](#udpclientfeederextensions) | class | Represents the UdpClientFeederExtensions class. | — | — |
| [`UdpClientFeederMessage`](#udpclientfeedermessage) | class | Represents the UdpClientFeederMessage class. | `FeederMessage;` | — |
...
- **Summary:** Represents the UdpClientFeederConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve UdpClientFeederConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### UdpClientFeederExtensions
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the UdpClientFeederExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve UdpClientFeederExtensions from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### UdpClientFeederMessage
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the UdpClientFeederMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve UdpClientFeederMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Feeders.UdpClient"]
  Current --> T0["UdpClientFeederConfiguration"]
  Current --> T1["UdpClientFeederExtensions"]
  Current --> T2["UdpClientFeederMessage"]
```

The diagram shows the direct components documented by the **Feeders.UdpClient** area.

## Examples

Start with `UdpClientFeederConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.

## See Also

- [Parent area](../README.md)
- [Providers.DotNet.UdpClient](../Providers.DotNet.UdpClient/README.md)
