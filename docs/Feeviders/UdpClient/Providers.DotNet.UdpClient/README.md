...
The **Providers.DotNet.UdpClient** area groups 3 documented types, including `UdpClientProviderConfiguration`, `UdpClientProviderExtensions`, `UdpClientProviderMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `ThunderPropagator.Providers.DotNet.UdpClient.csproj` | — | 9 | Defines project build targets, dependencies, and package metadata. |
| `UdpClientProvider.cs` | `UdpClientProvider`, `Log` | 100 | Defines UdpClientProvider, Log and its related behavior. |
| `UdpClientProviderConfiguration.cs` | `UdpClientProviderConfiguration` | 37 | Defines UdpClientProviderConfiguration and its related behavior. |
| `UdpClientProviderExtensions.cs` | `UdpClientProviderExtensions` | 27 | Defines UdpClientProviderExtensions and its related behavior. |
| `UdpClientProviderMessage.cs` | `UdpClientProviderMessage` | 6 | Defines UdpClientProviderMessage and its related behavior. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`UdpClientProviderConfiguration`](#udpclientproviderconfiguration) | class | Represents the UdpClientProviderConfiguration class. | `AbstractProviderConfiguration` | — |
| [`UdpClientProviderExtensions`](#udpclientproviderextensions) | class | Represents the UdpClientProviderExtensions class. | — | — |
| [`UdpClientProviderMessage`](#udpclientprovidermessage) | class | Represents the UdpClientProviderMessage class. | `FeederMessage;` | — |
...
- **Summary:** Represents the UdpClientProviderConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve UdpClientProviderConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### UdpClientProviderExtensions
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the UdpClientProviderExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve UdpClientProviderExtensions from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### UdpClientProviderMessage
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the UdpClientProviderMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve UdpClientProviderMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Providers.DotNet.UdpClient"]
  Current --> T0["UdpClientProviderConfiguration"]
  Current --> T1["UdpClientProviderExtensions"]
  Current --> T2["UdpClientProviderMessage"]
```

The diagram shows the direct components documented by the **Providers.DotNet.UdpClient** area.

## Examples

Start with `UdpClientProviderConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.

## See Also

- [Parent area](../README.md)
- [Feeders.UdpClient](../Feeders.UdpClient/README.md)
- [UdpClient.SharedKernel](../UdpClient.SharedKernel/README.md)
