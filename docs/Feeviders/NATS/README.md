...
The **NATS** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.NATS](./Feeders.NATS/README.md) `Types:3` `Files:7`
- [NATS.SharedKernel](./NATS.SharedKernel/README.md) `Types:5` `Files:8`
- [Providers.DotNet.NATS](./Providers.DotNet.NATS/README.md) `Types:3` `Files:6`
...
graph TD
  Current["NATS"]
  Current --> C0["Feeders.NATS"]
  Current --> C1["NATS.SharedKernel"]
  Current --> C2["Providers.DotNet.NATS"]
```
