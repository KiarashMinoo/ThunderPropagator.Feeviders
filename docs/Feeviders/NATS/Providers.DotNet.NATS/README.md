...
The **Providers.DotNet.NATS** area groups 3 documented types, including `NatsProviderConfiguration`, `NatsProviderExtensions`, `NatsProviderMessage`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `NatsProvider.cs` | `NatsProvider`, `Log` | 145 | Defines NatsProvider, Log and its related behavior. |
| `NatsProviderConfiguration.cs` | `NatsProviderConfiguration` | 34 | Defines NatsProviderConfiguration and its related behavior. |
| `NatsProviderExtensions.cs` | `NatsProviderExtensions` | 41 | Defines NatsProviderExtensions and its related behavior. |
| `NatsProviderMessage.cs` | `NatsProviderMessage` | 6 | Defines NatsProviderMessage and its related behavior. |
| `ThunderPropagator.Providers.DotNet.NATS.csproj` | — | 8 | Defines project build targets, dependencies, and package metadata. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`NatsProviderConfiguration`](#natsproviderconfiguration) | class | Represents the NatsProviderConfiguration class. | `AbstractNatsFeevidersConfiguration, IAbstractProviderConfiguration` | — |
| [`NatsProviderExtensions`](#natsproviderextensions) | class | Represents the NatsProviderExtensions class. | — | — |
| [`NatsProviderMessage`](#natsprovidermessage) | class | Represents the NatsProviderMessage class. | `FeederMessage;` | — |

### NatsProviderConfiguration

- **Kind:** class
- **Namespace:** `ThunderPropagator.Providers.DotNet.NATS`
- **Inherits/implements:** `AbstractNatsFeevidersConfiguration, IAbstractProviderConfiguration`
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the NatsProviderConfiguration class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve NatsProviderConfiguration from the configured service container or construct it with its declared dependencies.
```

[↑ Back to top](#contents)

### NatsProviderExtensions
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the NatsProviderExtensions class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve NatsProviderExtensions from the configured service container or construct it with its declared dependencies.
```
...
- **Attributes:** None detected
- **Key members:** Refer to the API surface in the source package
- **Summary:** Represents the NatsProviderMessage class.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve NatsProviderMessage from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["Providers.DotNet.NATS"]
  Current --> T0["NatsProviderConfiguration"]
  Current --> T1["NatsProviderExtensions"]
  Current --> T2["NatsProviderMessage"]
```

The diagram shows the direct components documented by the **Providers.DotNet.NATS** area.

## Examples

Start with `NatsProviderConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.
