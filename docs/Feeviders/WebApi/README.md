...
The **WebApi** area organizes 2 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.WebApi](./Feeders.WebApi/README.md) `Types:3` `Files:6`
- [Providers.DotNet.WebApi](./Providers.DotNet.WebApi/README.md) `Types:3` `Files:6`
...
graph TD
  Current["WebApi"]
  Current --> C0["Feeders.WebApi"]
  Current --> C1["Providers.DotNet.WebApi"]
```
