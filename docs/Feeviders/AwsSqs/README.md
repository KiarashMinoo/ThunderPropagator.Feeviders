...
The **AwsSqs** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [AwsSqs.SharedKernel](./AwsSqs.SharedKernel/README.md) `Types:1` `Files:4`
- [Feeders.AwsSqs](./Feeders.AwsSqs/README.md) `Types:3` `Files:7`
- [Providers.DotNet.AwsSqs](./Providers.DotNet.AwsSqs/README.md) `Types:6` `Files:12`
...
graph TD
  Current["AwsSqs"]
  Current --> C0["AwsSqs.SharedKernel"]
  Current --> C1["Feeders.AwsSqs"]
  Current --> C2["Providers.DotNet.AwsSqs"]
```
