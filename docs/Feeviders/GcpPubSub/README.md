...
The **GcpPubSub** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [Feeders.GcpPubSub](./Feeders.GcpPubSub/README.md) `Types:3` `Files:8`
- [GcpPubSub.SharedKernel](./GcpPubSub.SharedKernel/README.md) `Types:1` `Files:5`
- [Providers.DotNet.GcpPubSub](./Providers.DotNet.GcpPubSub/README.md) `Types:3` `Files:6`
...
graph TD
  Current["GcpPubSub"]
  Current --> C0["Feeders.GcpPubSub"]
  Current --> C1["GcpPubSub.SharedKernel"]
  Current --> C2["Providers.DotNet.GcpPubSub"]
```

The diagram shows the direct components documented by the **GcpPubSub** area.
