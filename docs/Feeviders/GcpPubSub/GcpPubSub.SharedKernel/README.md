...
The **GcpPubSub.SharedKernel** area groups 1 documented type, including `IGcpPubSubFeeviderConfiguration`. It provides the contracts and implementation used by this part of ThunderPropagator.Feeviders.
...
| `IGcpPubSubFeeviderConfiguration.cs` | `IGcpPubSubFeeviderConfiguration` | 6 | Defines IGcpPubSubFeeviderConfiguration and its related behavior. |
| `PubSubClientFactory.cs` | `PubSubClientFactory` | 59 | Defines PubSubClientFactory and its related behavior. |
| `PubSubMessagePropagation.cs` | `PubSubMessagePropagation` | 36 | Defines PubSubMessagePropagation and its related behavior. |
| `ThunderPropagator.Feeviders.GcpPubSub.SharedKernel.csproj` | — | 15 | Defines project build targets, dependencies, and package metadata. |

## Types and Members

| Type | Kind | Summary | Inherits/Implements | Key Members |
|---|---|---|---|---|
| [`IGcpPubSubFeeviderConfiguration`](#igcppubsubfeeviderconfiguration) | interface | Represents the IGcpPubSubFeeviderConfiguration interface. | — | — |

### IGcpPubSubFeeviderConfiguration
...
- **Summary:** Represents the IGcpPubSubFeeviderConfiguration interface.
- **Thread safety:** Follow the lifetime and concurrency guarantees of the owning component; no additional guarantee is inferred.

**Usage recipe**

```csharp
// Resolve IGcpPubSubFeeviderConfiguration from the configured service container or construct it with its declared dependencies.
```
...
```mermaid
graph TD
  Current["GcpPubSub.SharedKernel"]
  Current --> T0["IGcpPubSubFeeviderConfiguration"]
```

The diagram shows the direct components documented by the **GcpPubSub.SharedKernel** area.

## Examples

Start with `IGcpPubSubFeeviderConfiguration` as the primary entry point for this folder, then follow its linked contracts and collaborators.
