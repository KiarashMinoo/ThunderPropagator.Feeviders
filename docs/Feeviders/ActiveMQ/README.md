...
The **ActiveMQ** area organizes 3 direct sub-areas. Each child is documented separately so responsibilities and APIs remain easy to navigate.
...
- [ActiveMQ.SharedKernel](./ActiveMQ.SharedKernel/README.md) `Types:1` `Files:5`
- [Feeders.ActiveMQ](./Feeders.ActiveMQ/README.md) `Types:3` `Files:7`
- [Providers.DotNet.ActiveMQ](./Providers.DotNet.ActiveMQ/README.md) `Types:3` `Files:6`
...
graph TD
  Current["ActiveMQ"]
  Current --> C0["ActiveMQ.SharedKernel"]
  Current --> C1["Feeders.ActiveMQ"]
  Current --> C2["Providers.DotNet.ActiveMQ"]
```
